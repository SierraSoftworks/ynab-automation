...
const alphavantage_1 = require("./alphavantage");
describe.skip("AlphaVantage Stock API", () => {
    const alphaVantage = new alphavantage_1.AlphaVantage(process.env.ALPHAVANTAGE_API_KEY);
    describe("getCurrencyData", () => {
        it("should return currency data for a pair of currencies", () => __awaiter(void 0, void 0, void 0, function* () {
            const rate = yield alphaVantage.getCurrencyData("USD", "EUR");
    ...
    describe("getStockData", () => {
        it("should return data for a stock", () => __awaiter(void 0, void 0, void 0, function* () {
            const data = yield alphaVantage.getStockData("HCP");
...
//# sourceMappingURL=alphavantage.spec.js.map